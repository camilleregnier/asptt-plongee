...
import com.asptt.plongee.resa.service.ReservationService;
...
@WebService(endpointInterface = "com.asptt.plongee.resa.service.ReservationService",
...
//	@Override
	...
	public List<Plongee> rechercherPlongeeProchainJour(boolean isVesteRouge)  throws TechnicalException{
...
//	@Override
	...
	@Override
	public List<Plongee> rechercherPlongeesAdherentInscrit(String numeroLicense, int nbHours)  throws TechnicalException{
		Adherent adherent = new Adherent();
		adherent.setNumeroLicense(numeroLicense);
