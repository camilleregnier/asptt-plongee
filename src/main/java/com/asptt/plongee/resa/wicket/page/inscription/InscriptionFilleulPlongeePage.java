...
import com.asptt.plongee.resa.wicket.page.secretariat.ExterieurPanel;
        ...
        public ExterieurForm(String id) {
            ...
            add(new IndicatingAjaxSubmitButton("valider", this) {
                ...
                protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                    setResponsePage(new InscriptionPlongeePage(parrain, ResaSession.get().getAdherentService().rechercherAdherentParIdentifiant(autocompleteField.getConvertedInput())));
                }
            });
            ...
            add(new IndicatingAjaxSubmitButton("modifier", this) {
                @Override
                protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                    IModel<Adherent> ext = new DetachableAdherentModel(ResaSession.get().getAdherentService().rechercherAdherentParIdentifiant(autocompleteField.getConvertedInput()));
