 ...
 * @author ecus6396
 */
public class GererAdherentsConfReInitPwdPanel extends Panel {

    private static final long serialVersionUID = 196724625616748115L;

    @SuppressWarnings("unchecked")
    public GererAdherentsConfReInitPwdPanel(String id, final IModel<Adherent> adherent) {
        super(id);
        init(adherent);
    }
    ...
    private void init(final IModel<Adherent> adherent) {
        ...
        add(new IndicatingAjaxLink("yes") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ResaSession.get().getAdherentService().reinitPwdAdherent(adherent.getObject());
                GererAdherents.getModalPwd().close(target);
