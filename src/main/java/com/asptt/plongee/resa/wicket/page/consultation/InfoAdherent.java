...
public class InfoAdherent extends TemplatePage {
    ...
    public InfoAdherent() {
        ...
        add(new Label("message", new StringResourceModel(CatalogueMessages.INFO_ADHERENT_MSG, this, new Model<Adherent>(ResaSession.get().getAdherent()))));
...
//		private static final long serialVersionUID = 5374674730458593314L;
        ...
        Adherent adherent = ResaSession.get().getAdherentService().rechercherAdherentParIdentifiant(ResaSession.get().getAdherent().getNumeroLicense());
