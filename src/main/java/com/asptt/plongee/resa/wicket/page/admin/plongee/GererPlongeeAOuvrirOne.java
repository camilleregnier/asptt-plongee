...
public class GererPlongeeAOuvrirOne extends TemplatePage {
    ...
    public GererPlongeeAOuvrirOne() {
        ...
        add(new Label("message", new StringResourceModel(CatalogueMessages.PLONGEE_A_OUVRIR_ONE_MSG, this, new Model<Adherent>(ResaSession.get().getAdherent()))));
    }
    ...
    public class GererListeAttenteOneForm extends Form {
        ...
        public GererListeAttenteOneForm(String name, IFeedback feedback) {
            ...
            data = ResaSession.get().getPlongeeService().rechercherPlongeeAOuvrir(
