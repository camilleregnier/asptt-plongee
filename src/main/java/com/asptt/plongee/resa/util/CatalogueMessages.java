...
public interface CatalogueMessages {
    ...
    /**
     * AccueilPage + InscriptionPlongeePage msg dans
     * PlongeeApplication.properties inscription.impossible
     */
    ...
    /**
     * GererListePlongeeAddFS
     */
    //message de haut de page
    public final String GERER_ADD_FS_MSG = "message";
    /**
     * SaisieFicheSecurite
     */
    //message de haut de page
    public final String SAISIE_FS_MSG = "message";
    /**
     * SaisiePalanquePage
     */
    //message de haut de page
    public final String SAISIE_PALANQUE_MSG_PLONGEE = "messagePlongee";
    public final String SAISIE_PALANQUE_MSG_SITE = "messageSite";
    public final String SAISIE_PALANQUE_MSG_METEO = "messageMeteo";
    public final String SAISIE_PALANQUE_MSG_NUM_PALANQUE = "messageNumPalanque";
}
