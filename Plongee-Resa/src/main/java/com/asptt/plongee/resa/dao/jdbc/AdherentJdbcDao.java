...
import com.asptt.plongee.resa.model.Adherent.Aptitude;
...
public class AdherentJdbcDao extends AbstractJdbcDao implements Serializable, AdherentDao {
    ...
    public Adherent create(Adherent adh) throws TechnicalException {
        ...
        try {
            ...
            sb.append("INSERT INTO ADHERENT (`LICENSE`, `NOM`, `PRENOM`, `NIVEAU`, `TELEPHONE`, `MAIL`, `ENCADRANT`, `PILOTE`, `DATE_DEBUT`, `ACTIF`, `PASSWORD`, `DATE_CM`, `ANNEE_COTI`, `TIV`, `COMMENTAIRE`, `APTITUDE`)");
    ...
    public Adherent update(Adherent adh) throws TechnicalException {
        ...
        try {
            ...
            if (adh.isAptitude()) {
                st.setString(13, adh.getAptitude());
            } else {
                st.setString(13, null);
            }
            st.setString(14, adh.getNumeroLicense());
            if (st.executeUpdate() == 0) {
                throw new TechnicalException(
    ...
    public Adherent updateExterne(Adherent ext) throws TechnicalException {
        ...
        try {
            ...
            if (ext.isAptitude()) {
                st.setString(5, ext.getAptitude());
            } else {
                st.setString(5, null);
            }
            st.setString(6, ext.getNumeroLicense());
            if (st.executeUpdate() == 0) {
                throw new TechnicalException(
