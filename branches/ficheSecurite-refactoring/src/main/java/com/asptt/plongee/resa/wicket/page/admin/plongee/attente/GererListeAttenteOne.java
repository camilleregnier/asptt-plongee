...
public class GererListeAttenteOne extends TemplatePage {
    ...
    public GererListeAttenteOne() {
        ...
        add(new Label("message", new StringResourceModel(CatalogueMessages.LISTE_ATTENTE_ONE_MSG, this, new Model<Adherent>(ResaSession.get().getAdherent()))));
    ...
    public class GererListeAttenteOneForm extends Form {
        ...
        public GererListeAttenteOneForm(String name, IFeedback feedback) {
            ...
            plongees = ResaSession.get().getPlongeeService().rechercherPlongeesOuvertesWithAttente(
                    ResaSession.get().getPlongeeService().rechercherPlongeeTout());
