...
public class GererPlongeeAOuvrirTwo extends TemplatePage {
    ...
    public GererPlongeeAOuvrirTwo(final Plongee plongee) {
        ...
        List<Adherent> dps;
        dps = ResaSession.get().getAdherentService()
                .rechercherDPsNonInscrits(
                ResaSession.get().getAdherentService()
        ...
        List<Adherent> pilotes = ResaSession.get().getAdherentService()
                .rechercherPilotesNonInscrits(ResaSession.get().getAdherentService().rechercherAdherentsActifs(), plongee);
        ...
        final Form<Plongee> form = new Form<Plongee>("form") {
            ...
            protected void onSubmit() {
                ...
                for (String id : idInscrits) {
                    adhInscrits.add(ResaSession.get().getAdherentService()
                ...
                for (Adherent adh : adhInscrits) {
                    try {
                        ResaSession.get().getPlongeeService().inscrireAdherent(
        ...
        public PlongeePanel(String id, IModel<Plongee> plongee) {
            ...
            formPlongee.add(new AjaxButton("validPlongee") {
                ...
                protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                    ...
                    ResaSession.get().getPlongeeService().modifierPlongee(plongee);
